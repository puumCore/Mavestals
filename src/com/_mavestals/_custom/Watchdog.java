...
public abstract class Watchdog {
    ...
    public final void information_message(@NotNull String message) {
        try {
            ...
            java.awt.image.BufferedImage bufferedImage = ImageIO.read(getClass().getResource("/com/_mavestals/_image/_icon/png_logo.png"));
    ...
    protected final Notifications warning_message(String title, String text) {
        Image image = new Image("/com/_mavestals/_image/_icon/warn.png");
    ...
    public final void success_notification(@NotNull String about) {
        try {
            SystemTray systemTray = SystemTray.getSystemTray();
            java.awt.image.BufferedImage bufferedImage = ImageIO.read(getClass().getResource("/com/_mavestals/_image/_icon/ok.png"));
            TrayIcon trayIcon = new TrayIcon(bufferedImage);
            trayIcon.setImageAutoSize(true);
            systemTray.add(trayIcon);
    ...
    public final Notifications error_message(String title, String text) {
        Image image = new Image("/com/_mavestals/_image/_icon/error.png");
        return Notifications.create()
                .title(title)
                .text(text)
                .graphic(new ImageView(image))
